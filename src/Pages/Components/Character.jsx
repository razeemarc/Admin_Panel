          ...
          <Card.Body>
            ...
            <Form onSubmit={handleSubmit}>
              <Form.Group controlId={`formTextField${conversationNumber}1`}>
                ...
                <Form.Control type="text" placeholder="Enter text" value={character1} onChange={(e) => setCharacter1(e.target.value)} required   style={{ borderRadius: '32px' }}/>
              </Form.Group>
              <Form.Group controlId={`formTextField${conversationNumber}2`}>
                <Form.Label>Character 2</Form.Label>
                <Form.Control type="text" placeholder="Enter text" value={character2} onChange={(e) => setCharacter2(e.target.value)} required  style={{ borderRadius: '32px' }}/>
              </Form.Group>
              <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <button style={{ marginTop: '10px', width: "100%" }} className='second-btn' type="submit">
                  Update
                </button>
              </div>
            </Form>
      ...
      {isUpdated && (
        <div className="alert-container">
          <div className="alert-box">
            ...
            <button  className='normal-btn' style={{padding:" 3px 25px 3px",marginLeft:'50px'}} onClick={handleAlertClose}>OK</button>
          </div>
        </div>
      )}
    </>
